    ...
    <div class="container mx-auto px-6 py-3">
        ...
        <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
            <div class=" block max w-full">
                <a class="mr-1 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="{{ url('/') }}">Home</a>
{{--
                <a class="mr-1 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="{{ url('products') }}">Products</a>
--}}
                @if (Auth::guest())
                    <a class="ml-auto mr-1 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="{{ url('login') }}">Sign-in</a>
                @endif
            </div>
        </nav>
